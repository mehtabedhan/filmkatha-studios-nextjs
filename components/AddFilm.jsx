  ...
  return (
    <div className='w-full min-h-screen flex items-center justify-center bg-white'>
        <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
          ...
          <div className="w-full">
            <select onChange={(e)=>{ setCurrentGenre(e.target.value)}} className="outline-none w-full text-base border-b-2 border-gray-200 p-2 rounded-md cursor-pointer">
   ...
   <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
          ...
          
          {
            ...
            <ReactDatePicker selected={releaseDate} onChange={(date) => setReleaseDate(date)} />
